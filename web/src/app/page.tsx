      ...
      <section className="py-16">
        <Container>
          <div className="max-w-3xl">
            <h1 className="text-3xl sm:text-4xl font-bold tracking-tight">Building fast, accessible web experiences.</h1>
            <p className="mt-3 text-base text-muted-foreground">
              I craft modern apps with Next.js, TypeScript, and great UX. Explore selected projects below
              or get in touch.
            </p>
