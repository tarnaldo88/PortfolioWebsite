...
export const projects: Project[] = [
  ...
  }, 
  {
    ...
    techStack: ["C#","ASP.NET", "Blazor Web Assembly", "Entity Framework","SQL Server", "ASP.NET Core Web API", "JWT"],
  ...
  },  
  {
    ...
    slug: "threadpool",
    shortDescription: "A high-performance C++ thread pool implementation using work-stealing queues for efficient task distribution and load balancing.",
    techStack: ["C++", "networking", "multithreading", "Cache Localtiy", "Load Balancing", "Priority Scheduling"],
    tags: ["C++", "networking", "multithreading", "Cache Localtiy", "Load Balancing", "Priority Scheduling"],
    status: "released",
    featured: false,
